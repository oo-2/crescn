...
const NotFound = () => {
  return (
    <section class="min-h-screen flex flex-col">
      <div class="container mx-auto flex flex-col py-5 justify-center items-center ">
        <img
      ...
      <div className="justify-center flex flex-col sm:flex-row m-auto ">
        <div className="container m-auto text-center sm:text-right ">
          ...
          <p class="text-3xl text-white text-opacity-70 font-light pb-3">
            Page not found.
          </p>
          <a href="/">
            <button class="text-white bg-purple-700 hover:bg-purple-800 py-2 px-6 rounded text-lg">
              Home
            </button>
          </a>
        </div>
